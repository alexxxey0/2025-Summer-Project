                ...
                <div className="w-full lg:w-6/12 xl:w-4/12 flex flex-col items-center">
                    ...
                    <div className="flex flex-col w-full mt-4 lg:mt-16 items-start gap-y-2">
                        ...
                        <div className="flex flex-row gap-x-4 w-full">
                            <button className="bg-black text-white rounded-xl px-2 py-2 w-4/12 cursor-pointer h-10/12" onClick={auth.user ? addCartItemDb : addCartItemSession}>Add to cart</button>
                            <div className="flex flex-col">
                                <input className="border-2 border-black rounded-xl p-1 w-10/12" type="number" name="quantity" id="quantity" value={quantity} onChange={(e) => handleQuantityChange(e)} min={1} max={product.in_stock[selectedSize]} />
